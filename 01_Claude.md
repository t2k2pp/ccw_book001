...
| モデル | 特徴 | 用途 |
|--------|------|------|
| **Claude 3.5 Opus** | 最高性能、最も高度な推論 | 複雑な分析、高度な創作 |
| **Claude 3.5 Sonnet** | バランス型、コスパ最高 | 一般的な対話、コード生成 |
| **Claude 3.5 Haiku** | 最速、低コスト | 大量処理、チャットボット |
...
quadrant-chart
    ...
    quadrant-3 エコノミー
    quadrant-4 バランス型
    Claude 3.5 Haiku: [0.2, 0.6]
    Claude 3.5 Sonnet: [0.5, 0.85]
    Claude 3.5 Opus: [0.9, 0.95]
    Claude 3 Opus: [0.8, 0.8]
```
...
| 用途 | 推奨モデル | 理由 |
|------|-----------|------|
| 複雑な分析・推論 | Opus | 最高レベルの理解力 |
| コード生成 | Sonnet | 速度と精度のバランス |
| チャットボット | Haiku | 高速レスポンス、低コスト |
| 長文要約 | Sonnet | 大量テキスト処理に最適 |
| 画像解析 | Sonnet/Opus | Vision機能を持つモデル |
