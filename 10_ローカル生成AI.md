...
| 5 | **GLM-4シリーズ** | Zhipu AI | 9B-32B | 70.1% (9B) | 64.2% SWE-bench (4.5) | ⭐⭐⭐⭐⭐ |
| 6 | **Qwen3-VL** | Alibaba | 4B-235B | ビジュアルコーディング | OCRBench 896 | ⭐⭐⭐⭐⭐ |
| 7 | **Kimi K2** | Moonshot AI | 1T (32B active) | - | 最先端（数学・コード） | ⭐⭐⭐⭐⭐ |
| 8 | **DeepSeek Coder V2** | DeepSeek | 6.7B-236B | - | 37.6% | ⭐⭐⭐⭐⭐ |
| 9 | **Gemma 3** | Google | 1B-27B | ⭐高 | ⭐高 | ⭐⭐⭐⭐⭐ |
| 10 | **Llama 4** | Meta | 70B+ MoE | - | マルチモーダル | ⭐⭐⭐⭐ |
| 11 | **StarCoder2** | BigCode | 3B-15B | 33B+級性能 | - | ⭐⭐⭐⭐ |
| 12 | **Gemma 3n** | Google | E2B/E4B | モバイル最強 | - | ⭐⭐⭐⭐ |
...
🎯 **エージェント型特化**: GLM-4-9B-Chat
- 理由: ツール呼び出し90.6%（業界最高）、Function Calling最強
